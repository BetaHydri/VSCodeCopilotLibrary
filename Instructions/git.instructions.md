...
When working with Git repositories, adhere to the following comprehensive guidelines for commit messages, branch naming, `.gitignore` management, and workflow conventions. These conventions support GitVersion, Conventional Commits, and team collaboration.
