...
When working with JSON and JSONC (JSON with Comments) files, adhere to the following comprehensive guidelines for formatting, validation, and common patterns.
