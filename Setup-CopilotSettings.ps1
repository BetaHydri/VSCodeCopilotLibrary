...
.DESCRIPTION
    Derives the folder name from the repository root (e.g. VSCodeCopilotLibrary)
...
if (-not (Test-Path $settingsPath)) {
    Write-Error "VS Code settings file not found at $settingsPath"
    return
}

# Back up the settings file with a timestamp
