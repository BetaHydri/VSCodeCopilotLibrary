...
### Step 1 — Parse the request into a LabConfig hashtable
...
### Step 3 — Execute deployment (MUST run, not just print)
...
### Step 4 — Wait for deployment (MANDATORY — do NOT skip)
...
### Step 4.5 — Internet connectivity fix (MANDATORY for internet-facing labs)
...
### Step 5 — Post-deployment validation tests (MANDATORY)
