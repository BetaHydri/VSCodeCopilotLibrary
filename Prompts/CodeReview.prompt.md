# PowerShell Security Code Review — Prompt Guide

## Overview

This prompt guide drives a structured, multi-phase security code review for
PowerShell projects. It uses custom detection rules aligned to CWE taxonomy,
PSScriptAnalyzer, and Pester to produce reports in both human-readable Markdown
and machine-readable SARIF v2.1.0 format. Findings are scored using CVSS v4.0
Base (CVSS-B) and annotated with a confidence level to separate noise from real
risk.
...
## Prompt 5 — Create Additional Documentation
