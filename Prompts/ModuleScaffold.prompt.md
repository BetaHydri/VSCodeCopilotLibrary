...
`argument-hint`: Provide the module name and a brief description of its purpose.

## Variables

- `moduleName` — The name of the new module (e.g., `MyModule`)
- `moduleDescription` — A brief description of the module's purpose
